...
import org.hibernate.aql.internal.ast.*;
import org.hibernate.aql.internal.ast.util.*;
 ...
 */
class AqlBaseParser extends Parser;
 ...
 * @author Joshua Davis (pgmjsd@sourceforge.net)
 */
class AqlBaseLexer extends Lexer;

options {
	exportVocab=Aql;      // call the vocabulary "Hql"
	testLiterals = false;
