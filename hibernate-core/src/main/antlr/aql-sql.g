header
{
package org.hibernate.aql.internal.antlr;
 ...
 */
class AqlSqlBaseWalker extends TreeParser;
...
options
{
	...
	importVocab=Aql;        // import definitions from "Hql"
	exportVocab=AqlSql;     // Call the resulting definitions "HqlSql"
	buildAST=true;
}
...
// -- Declarations --
{
    private static final CoreMessageLogger LOG = Logger.getMessageLogger(CoreMessageLogger.class, AqlSqlBaseWalker.class.getName());
