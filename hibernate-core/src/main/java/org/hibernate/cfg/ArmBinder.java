...
import org.hibernate.mapping.RootArchetype;
 ...
 * @author Gavin King
 */
public final class ArmBinder {

    private static final CoreMessageLogger LOG = Logger.getMessageLogger(CoreMessageLogger.class, ArmBinder.class.getName());
	...
	public static void bindRoot(
		...
		java.util.List<String> names = ArmBinder.getExtendsNeeded( metadataXml, mappings );
		if ( !names.isEmpty() ) {
	...
	private static void bindRootPersistentArchetypeCommonValues(Element node,
		...
		Table table = mappings.addTable(
				schema,
				catalog,
				getArchetypeTableName( entity, node, schema, catalog, null, mappings ),
				getSubselect( node ),
...
//			entity.setProxyInterfaceName( className );
		...
		if ( tuplizer != null ) {
			entity.addTuplizer( EntityMode.POJO, tuplizer.attributeValue( "archetype" ) );
		}
	}
...
//			}
	...
	static class CollectionSecondPass extends org.hibernate.cfg.CollectionSecondPass {
		...
		public void secondPass(java.util.Map persistentClasses, java.util.Map inheritedMetas)
				throws MappingException {
			ArmBinder.bindCollectionSecondPass(
					node,
					collection,
					persistentClasses,
					mappings,
	...
	static class IdentifierCollectionSecondPass extends CollectionSecondPass {
		...
		public void secondPass(java.util.Map persistentClasses, java.util.Map inheritedMetas)
				throws MappingException {
			ArmBinder.bindIdentifierCollectionSecondPass(
					node,
