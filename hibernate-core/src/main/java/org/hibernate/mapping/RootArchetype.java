 ...
 * @author Gavin King
 */
public class RootArchetype extends PersistentArchetype implements TableOwner, ArchetypeOwner {

    private static final CoreMessageLogger LOG = Logger.getMessageLogger(CoreMessageLogger.class, RootArchetype.class.getName());
	...
	@Override
    public RootArchetype getRootClass() {
		return this;
	}
	...
	@Override
    public PersistentArchetype getSuperclass() {
		return null;
	}
	...
	public void setIdentifierProperty(Property identifierProperty) {
		...
		identifierProperty.setPersistentArchetype(this);
