 ...
 * @author Gavin King
 */
public abstract class PersistentArchetype implements Serializable, Filterable, MetaAttributable {
	...
	public void addSubclass(Subclass subclass) throws MappingException {
		...
		PersistentArchetype superclass = getSuperclass();
	...
	public Iterator getSubclassClosureIterator() {
		...
		while ( iter.hasNext() ) {
			PersistentArchetype clazz = (PersistentArchetype)  iter.next();
...
//		p.setPersistentClass(this);
	...
	public abstract PersistentArchetype getSuperclass();
