...
import org.hibernate.aql.internal.QuerySplitter;
...
import org.hibernate.aql.spi.QueryTranslatorFactory;
 ...
 */
public class AQLQueryPlan implements Serializable {

    // TODO : keep separate notions of QT[] here for shallow/non-shallow queries...

    private static final CoreMessageLogger LOG = Logger.getMessageLogger(CoreMessageLogger.class, AQLQueryPlan.class.getName());
	...
	public AQLQueryPlan(String hql, boolean shallow, Map enabledFilters, SessionFactoryImplementor factory) {
		this( hql, null, shallow, enabledFilters, factory );
	}

	protected AQLQueryPlan(String hql, String collectionRole, boolean shallow, Map enabledFilters,  SessionFactoryImplementor factory){
		...
		final QueryTranslatorFactory queryTranslatorFactory = factory.getSettings().getAqlQueryTranslatorFactory();
