...
import org.hibernate.aql.internal.classic.ParserHelper;
...
public class JoinProcessor implements SqlTokenTypes {
	...
	private final AqlSqlWalker walker;
	 ...
	 */
	public JoinProcessor(AqlSqlWalker walker) {
		this.walker = walker;
