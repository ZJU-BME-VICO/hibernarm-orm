 ...
 *
 */
package org.hibernate.aql.internal.ast.util;
...
import org.hibernate.aql.internal.ast.AqlSqlWalker;
import org.hibernate.aql.internal.ast.InvalidPathException;
...
public class LiteralProcessor implements HqlSqlTokenTypes {
	...
	public LiteralProcessor(AqlSqlWalker hqlSqlWalker) {
