...
import org.hibernate.aql.internal.ast.tree.Node;
...
public class SyntheticAndFactory implements HqlSqlTokenTypes {
	...
	private AqlSqlWalker hqlSqlWalker;
	private AST thetaJoins;
	private AST filters;

	public SyntheticAndFactory(AqlSqlWalker hqlSqlWalker) {
