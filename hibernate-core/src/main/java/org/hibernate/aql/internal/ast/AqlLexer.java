...
import org.hibernate.aql.internal.antlr.AqlBaseLexer;
 ...
 */
class AqlLexer extends AqlBaseLexer {
	/**
	 * A logger for this class. *
	 */
	private boolean possibleID = false;

	public AqlLexer(InputStream in) {
		super( in );
	}

    public AqlLexer(Reader in) {
        super(in);
    }

	public void setTokenObjectClass(String cl) {
		this.tokenObjectClass = AqlToken.class;
	}
	...
	protected Token makeToken(int i) {
		AqlToken token = ( AqlToken ) super.makeToken( i );
