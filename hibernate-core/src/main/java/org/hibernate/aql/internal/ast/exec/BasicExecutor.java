 ...
 *
 */
package org.hibernate.aql.internal.ast.exec;
...
import org.hibernate.aql.internal.ast.QuerySyntaxException;
import org.hibernate.aql.internal.ast.SqlGenerator;
...
public class BasicExecutor implements StatementExecutor {
	...
	public BasicExecutor(AqlSqlWalker walker, Queryable persister) {
