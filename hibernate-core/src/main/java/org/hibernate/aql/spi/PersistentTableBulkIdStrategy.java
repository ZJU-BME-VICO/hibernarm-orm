...
//				session.getTransactionCoordinator().getJdbcCoordinator().release( statement );
	...
	@Override
	public UpdateHandler buildUpdateHandler(SessionFactoryImplementor factory, AqlSqlWalker walker) {
	...
	@Override
	public DeleteHandler buildDeleteHandler(SessionFactoryImplementor factory, AqlSqlWalker walker) {
