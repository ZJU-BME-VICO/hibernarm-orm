 ...
 */
package org.hibernate.loader.aql;
...
import org.hibernate.aql.internal.ast.QueryTranslatorImpl;
...
public class QueryLoader extends BasicLoader {
	 ...
	 */
	protected QueryTranslatorImpl queryTranslator;

	protected Queryable[] entityPersisters;
	protected String[] entityAliases;
	protected String[] sqlAliases;
	protected String[] sqlAliasSuffixes;
	protected boolean[] includeInSelect;

	protected String[] collectionSuffixes;

	protected boolean hasScalars;
	protected String[][] scalarColumnNames;
	//private Type[] sqlResultTypes;
	protected Type[] queryReturnTypes;

	protected final Map sqlAliasByEntityAlias = new HashMap(8);

	protected EntityType[] ownerAssociationTypes;
	protected int[] owners;
	protected boolean[] entityEagerPropertyFetches;

	protected int[] collectionOwners;
	protected QueryableCollection[] collectionPersisters;

	protected int selectLength;

	protected AggregatedSelectExpression aggregatedSelectExpression;
	protected String[] queryReturnAliases;

	protected LockMode[] defaultLockModes;


	public QueryLoader(final SessionFactoryImplementor factory) {
		super( factory );
	}
